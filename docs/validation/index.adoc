...
The ASM (Abstract Syntax Model) validation framework provides dual validation capabilities for EMF-based ASM models. It supports both EVL (Epsilon Validation Language) scripts and Java-based validation using the Judo Zeta Validation Framework.
...
The Java validation framework provides annotation-based validation that offers:
...
[source,java]
----
import hu.blackbelt.judo.meta.asm.validation.*;
import hu.blackbelt.judo.meta.asm.validation.core.*;
...
* https://github.com/BlackBeltTechnology/judo-zeta[Judo Zeta Framework] - The validation framework source
