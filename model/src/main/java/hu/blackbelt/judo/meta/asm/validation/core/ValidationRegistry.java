package hu.blackbelt.judo.meta.asm.validation.core;
...
public class ValidationRegistry {
    ...
    public void register(Class<?> validatorClass) {
        hu.blackbelt.judo.meta.asm.validation.annotation.ValidationContext contextAnnotation =
            validatorClass.getAnnotation(
                hu.blackbelt.judo.meta.asm.validation.annotation
    ...
    private void registerRule(
        ...
        hu.blackbelt.judo.meta.asm.validation.annotation.Guard guardAnnotation =
            ruleMethod.getAnnotation(
                hu.blackbelt.judo.meta.asm.validation.annotation.Guard.class
            );
            ...
            try {
                guardMethod = instance
                    ...
                    .getDeclaredMethod(
                        ...
                        EObject.class,
                        hu.blackbelt.judo.meta.asm.validation.core
                            .ValidationContext.class
                    );
